...
{
    public class FileTreeModel : ReactiveObject
    {
        //private static readonly Logger logger = LogManager.GetCurrentClassLogger();
        Logger fileTreeLogger = new Logger();
        ...
        private static FileTree _openedFolder;
        public static FileSystemWatcher _watcher;

        public FileTree OpenedFolder
        {
            get => _openedFolder;
        ...
        public FileTreeModel()
        {
            ...
            _openedFolder = new FileTree(_rootFolderPath, Directory.Exists(_rootFolderPath));
            ...
            Dispatcher.UIThread.Post(() =>
            {
                if (e.FullPath.StartsWith(_rootFolderPath) || _rootFolderPath.StartsWith(e.FullPath))
                {
                                                                              ...
                                                                              c == Path.AltDirectorySeparatorChar)))
                    {
                        ...
                        {
                            fileTreeLogger.logger.Info("22222");
                        }
                    }
                    else
                    {
            ...
            Dispatcher.UIThread.Post(() =>
            {
                ...
                if (e.FullPath.StartsWith(_rootFolderPath) || _rootFolderPath.StartsWith(e.OldFullPath))
                {
                    ...
                    else
                    {
                        ...
                        {
                            fileTreeLogger.logger.Info("222222");
                            StartWatch();
                        }
                    }
                }
        ...
        private FileTree SearchFile(string searchedFilePath)
        {
            {
        ...
        private FileTree SearchTreeParent(string searchedFilePath, FileTree openedFolder)
        {
        ...
        private FileTree SearchChildren(string searchedFilePath, FileTree rootFolder)
        {
        ...
        private void ChangePathChildren(FileTree changedFile)
        {
        ...
        private void ChangePathToTheRootFolder(FileTree fileTreeParent, string changedFilePath)
        {
